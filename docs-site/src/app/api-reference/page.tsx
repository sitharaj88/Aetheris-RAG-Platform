...
export default function ApiReferencePage() {
  ...
  -H "Content-Type: application/json" \\
  -d '{
    "query": "What is the token limit of Veridia?",
    "strategy": "adaptive",
    "collection": "default",
    "chat_history": []
  }'`,
      response: `{
  "answer": "According to the Veridia specifications, the default token configuration allows a context window of 8,192 tokens.",
  "sources": [
    {
  ...
  return (
    <div>
      ...
      <p className="text-text-secondary leading-relaxed">
        The Veridia platform exposes a unified, highly optimized HTTP REST interface to integrate advanced local RAG capabilities directly into external microservices or frontends.
      </p>
      ...
      {activeTab === "bff" && (
        <div className="space-y-6">
          ...
          <div className="doc-alert doc-alert-tip">
            <strong>Endpoint Override:</strong> If you are deploying the backend on a remote host, configure the <code>BACKEND_URL</code> environment variable inside the Next.js process environment to point to the remote address, e.g., <code>BACKEND_URL=https://api.veridia.internal</code>.
          </div>
        </div>
      )}
